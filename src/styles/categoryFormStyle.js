...
const formButtonStyle =
  "w-full flex justify-center items-center md:w-24 pt-0.5 rounded h-10 bg-primary hover:bg-[#be3737] disabled:bg-[#be3737] duration-300 text-white font-medium text-[17px] mb-5";
